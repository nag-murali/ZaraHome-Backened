...
async function getData () {
       ...
       if(result.success){
          totalfunc(result.address) 
                 
       }else{
          totalfunc([{"delivery_ads": null,
          "billing_ads": null}])     
       }
